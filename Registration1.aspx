<%@ Page Title="" Language="C#" MasterPageFile="~/ClientMaster.master" AutoEventWireup="true" CodeFile="Registration1.aspx.cs" Inherits="Registration1" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="auto-style11" style="height: 717px">
        <div class="auto-style12" style="height: 619px">
            ...
            <br />
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button1" ValidationGroup="Registration" CssClass="auto-style15" runat="server" Text="Submit" Width="140px" OnClick="Button1_Click" />
            </div>
        </div>
</asp:Content>
