...
public partial class Registration1 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand("insert into registration values('" + name.Text + "','" + email.Text + "','" + contact.Text + "','" + DropDownList2.SelectedItem.Value+"/"+DropDownList3.SelectedItem.Value+"/" +DropDownList4.SelectedItem.Value+"','" + gender.SelectedItem.Value + "','" + Type.SelectedItem.Value + "','" + Package.SelectedItem.Value + "','"+address.Text+"')" , con);
        con.Open();
